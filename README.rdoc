...
* a command to open <code>routes.rb</code> (I know it's usually just a couple of keystrokes: <code>Cmd-T, r, o, u, Enter</code>, but I open it so often it would be nice to just press e.g. Ctrl-Cmd-R)
